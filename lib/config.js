...
export const DEFAULTS = Object.freeze({
  ...
  knowledge: {
    ...
    scoreThreshold: 0.45,      // 关键词召回阈值（真机校准：金标 ≥0.75，噪音 ≤0.71，取分离带下沿）
    semanticGate: 0.5,         // 语义门槛：片段与查询的最高余弦 ≥ 此值才启用向量路（防盲目注入）
...
const KEYS = {
  ...
  knowledge: { enabled: 'boolean', paths: 'pathList', extensions: 'extList', maxFileBytes: 'number', maxFileChars: 'number', chunkChars: 'number', maxFiles: 'number', scoreThreshold: 'number', semanticGate: 'number', maxResults: 'number', maxTotalChars: 'number' },
